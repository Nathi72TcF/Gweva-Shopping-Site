      ...
      <div class="modal-body">
        <form action="cart/data.php?q=checkout" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="lname" class="form-control" placeholder="(ex. Dlamini)" required>
            </div>
            <div class="form-group">
                <label>Contact #</label>
                <input type="text" name="contact" class="form-control" placeholder="(ex. 067 880 4260)" required>
            </div>
            <div class="form-group">
                <label>Email</label>
                <input type="email" name="email" placeholder="(ex. info@gweva.co.za)" class="form-control">
            </div>
            <div class="form-group">
                <label>Complete Address</label>
                <input type="text" name="address" class="form-control" placeholder="(ex. 2397 Hlanganani St., kanana. EXT 5, Tembisa)" required>
            </div>
